...
class StartPage(tk.Frame):
    ...
    def get_options(self):
        ...
        # Calculate the remaining percentage for fold
        truefold = 100 - trueraise - truecall

        # Ensure no negative fold percentages
        if truefold < 0:
            truefold = 0

        #! Проверка минимального порога для рейза, колла и фолда !!!
        if trueraise < 30 and truecall < 30 and truefold < 30:
            self.statusvar.set("Wrong! All options are below 20% threshold")
            self.num += 1
        ...
        #! Условие для корректного ответа с порогом 20%
        if trueraise >= 30 and save_inp_raise > 0:
            correct_answer = True
        if truecall >= 30 and save_inp_call > 0:
            correct_answer = True
        if truefold >= 30 and save_inp_raise == 0 and save_inp_call == 0:
            correct_answer = True
    ...
    def rangepopup(self, raise_freq, call_freq, hi, hj):
        ...
        self.rpopup.geometry('%dx%d+%d+%d' % (ws*9/16*1.125, hs*9/16*1.125, ws/4, hs/4))
        ...
        #! цвет бордюра при проверки руки в диапазоне
        raiseExp.range_canvas.itemconfig(raiseExp.rectgrid[hj][hi], width=5, outline='#1B66C9')
        callExp.range_canvas.itemconfig(callExp.rectgrid[hj][hi], width=5, outline='#1B66C9')
        raiseExp.lock = True
        callExp.lock = True
...
class RangeEdit(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # EP vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-EPvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-EPvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'A1', text="EP vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "EP", "UTG"))

        # MP vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-MPvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-MPvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'B1', text="MP vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "MP", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'C1', text="MP vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "MP", "EP"))

        # HJ vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-HJvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-HJvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'D1', text="HJ vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "HJ", "UTG"))

        # HJ vs EP
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-HJvsEP.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-HJvsEP.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'E1', text="HJ vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "HJ", "EP"))

        # HJ vs MP
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-HJvsMP.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-HJvsMP.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'F1', text="HJ vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "HJ", "MP"))

        # CO vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-COvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-COvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'G1', text="CO vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "CO", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'H1', text="CO vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "CO", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'I1', text="CO vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "CO", "MP"))

        # CO vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-COvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-COvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'J1', text="CO vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "CO", "HJ"))

        # BN vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-BNvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-BNvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'K1', text="BN vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BN", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'L1', text="BN vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BN", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'M1', text="BN vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BN", "MP"))

        # BN vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-BNvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-BNvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'N1', text="BN vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BN", "HJ"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'O1', text="BN vs CO", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BN", "CO"))

        # SB vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-SBvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-SBvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'P1', text="SB vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "SB", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'Q1', text="SB vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "SB", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'R1', text="SB vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "SB", "MP"))

        # SB vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-SBvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-SBvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'S1', text="SB vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "SB", "HJ"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'T1', text="SB vs CO", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "SB", "CO"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'U1', text="SB vs BN", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "SB", "BN"))

        # BB vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-BBvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-BBvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'V1', text="BB vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BB", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'W1', text="BB vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BB", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'X1', text="BB vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BB", "MP"))

        # BB vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\3Bet-BBvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Flat-BBvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'Y1', text="BB vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BB", "HJ"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'Z1', text="BB vs CO", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BB", "CO"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'AA1', text="BB vs BN", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BB", "BN"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir2", "end", 'BB1', text="BB vs SB", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("1", "BB", "SB"))
        ...
        # EP vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-EPvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-EPvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'A3', text="EP vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "EP", "UTG"))

        # MP vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-MPvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-MPvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'B3', text="MP vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "MP", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'C3', text="MP vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "MP", "EP"))

        # HJ vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-HJvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-HJvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'D3', text="HJ vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "HJ", "UTG"))

        # HJ vs EP
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-HJvsEP.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-HJvsEP.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'E3', text="HJ vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "HJ", "EP"))

        # HJ vs MP
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-HJvsMP.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-HJvsMP.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'F3', text="HJ vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "HJ", "MP"))

        # CO vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-COvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-COvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'G3', text="CO vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "CO", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'H3', text="CO vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "CO", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'I3', text="CO vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "CO", "MP"))

        # CO vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-COvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-COvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'J3', text="CO vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "CO", "HJ"))

        # BN vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-BNvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-BNvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'K3', text="BN vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BN", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'L3', text="BN vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BN", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'M3', text="BN vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BN", "MP"))

        # BN vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-BNvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-BNvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'N3', text="BN vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BN", "HJ"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'O3', text="BN vs CO", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BN", "CO"))

        # SB vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-SBvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-SBvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'P3', text="SB vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "SB", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'Q3', text="SB vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "SB", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'R3', text="SB vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "SB", "MP"))

        # SB vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-SBvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-SBvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'S3', text="SB vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "SB", "HJ"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'T3', text="SB vs CO", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "SB", "CO"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'U3', text="SB vs BN", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "SB", "BN"))

        # BB vs UTG
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-BBvsUTG.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-BBvsUTG.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'V3', text="BB vs UTG", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BB", "UTG"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'W3', text="BB vs EP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BB", "EP"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'X3', text="BB vs MP", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BB", "MP"))

        # BB vs HJ
        date1 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\5Bet-BBvsHJ.txt'))
        date2 = dt.datetime.fromtimestamp(os.path.getmtime('Range Packages\\' + range_dir + '\\Call4bet-BBvsHJ.txt'))
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'Y3', text="BB vs HJ", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BB", "HJ"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'Z3', text="BB vs CO", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BB", "CO"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'AA3', text="BB vs BN", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BB", "BN"))
        ...
        date = max(date1, date2)
        self.fileTree.insert("dir4", "end", 'AB3', text="BB vs SB", values=(f"{date:%Y-%m-%d %H:%M}"), tags=("3", "BB", "SB"))
